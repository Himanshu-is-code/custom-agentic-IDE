...
export const unicodeFilter = Object.freeze([
    '**',
...
export const indentationFilter = Object.freeze([
    '**',
...
export const copyrightFilter = Object.freeze([
    '**',
    '!**/*.desktop',
    '!**/*.json',
    '!**/*.jsonc',
...
export const tsFormattingFilter = Object.freeze([
    'src/**/*.ts',
    'test/**/*.ts',
    'extensions/**/*.ts',
    '!src/vs/*/**/*.d.ts',
...
export const eslintFilter = Object.freeze([
    '**/*.{js,cjs,mjs}',
    '**/*.{ts,tsx,mts,cts}',
...
export const stylelintFilter = Object.freeze([
    'src/**/*.css'
]);
