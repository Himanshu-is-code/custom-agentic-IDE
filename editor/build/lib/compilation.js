...
export function createCompile(src, { build, emitError, transpileOnly, preserveEnglish, noEmit }) {
...
export function transpileTask(src, out, esbuild) {
    const task = () => {
...
export function watchTypeCheckTask(src) {
