 ...
 *--------------------------------------------------------------------------------------------*/
export function renderADMLString(prefix, moduleName, nlsString, translations) {
    let value;
    if (translations) {
...
export function renderProfileString(_prefix, moduleName, nlsString, translations) {
    let value;
    if (translations) {
        const moduleTranslations = translations[moduleName];
        if (moduleTranslations) {
...
export function renderADMX(regKey, versions, categories, policies) {
...
export function renderADML(appName, versions, categories, policies, translations) {
    return `<?xml version="1.0" encoding="utf-8"?>
...
export function renderProfileManifest(appName, bundleIdentifier, _versions, _categories, policies, translations) {
...
export function renderMacOSPolicy(product, policies, translations) {
...
export function renderGP(product, policies, translations) {
    const appName = product.nameLong;
...
export function renderJsonPolicies(policies) {
    const policyObject = {};
