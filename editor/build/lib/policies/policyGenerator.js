...
const product = JSON.parse(fs.readFileSync(path.join(import.meta.dirname, '../../../product.json'), 'utf8'));
...
async function parsePolicies(policyDataFile) {
    const contents = JSONC.parse(await fs.promises.readFile(policyDataFile, { encoding: 'utf8' }));
